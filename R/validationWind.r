validationWind <- function(obs, prd, upper.threshold = 20, lower.threshold = 1, lag.max = 3, lowVarPeriod = 1, Nbins = 100) {
      # Wind: upper.threshold = 20 km/h, lower.threshold = 1 km/h
