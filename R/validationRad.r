validationRad <- function(obs, prd, upper.threshold = 450, lower.threshold = 120, lag.max = 3, lowVarPeriod = 1, Nbins = 100) {
      # Radiation: upper.threshold = 450W/m^2/h, lower.threshold = 120W/m^2/h

      validation <- array(data = NA, dim = c(5,dim(obs$Data)[2],1,69), dimnames = list(season = c("Annual","DJF","MAM","JJA","SON"), stations = dimnames(obs$xyCoords)[[1]], realizations = 1, score = c("obsMean","obsVar","obsSkewness","obsW20","obsW1","obsW98p","obsACF1","obsACF2","obsACF3","obsRV20lb","obsRV20ub","obsMinAC","obsMaxAC","obsAmpAC","obsRelAmpAC","obsMeanJan","obsMeanFeb","obsMeanMar","obsMeanApr","obsMeanMay","obsMeanJun","obsMeanJul","obsMeanAug","obsMeanSep","obsMeanOct","obsMeanNov","obsMeanDec","obsHighSpell50","obsHighSpell90","obsMaxHighSpell","obsSlowSpell50","obsSlowSpell90","obsMaxSlowSpell","obsProVarLowFreq","cmIndex","prdMean","prdVar","prdSkewness","prdW20","prdW1","prdW98p","prdACF1","prdACF2","prdACF3","prdRV20lb","prdRV20ub","prdMinAC","prdMaxAC","prdAmpAC","prdRelAmpAC","prdMeanJan","prdMeanFeb","prdMeanMar","prdMeanApr","prdMeanMay","prdMeanJun","prdMeanJul","prdMeanAug","prdMeanSep","prdMeanOct","prdMeanNov","prdMeanDec","prdHighSpell50","prdHighSpell90","prdMaxHighSpell","prdSlowSpell50","prdSlowSpell90","prdMaxSlowSpell","prdProVarLowFreq")))
